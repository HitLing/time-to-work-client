...
const Client = () => {
    ...
    function deletePost(id) {
        const url = ClientsUrl.API_URL_BASE+`/${id}`;
  ...
  return (
    <Grid container spacing={1}>
        ...
        <Grid container
                ...
                {BASIC_DATA.map((row) => (
                    ...
                    >
                        ...
                        <TableCell component="th" scope="row">
                            ...
                            <IconButton 
                                onClick={() => { if(window.confirm(`Вы уверены, что хотите удалить клиента: "${row.name}"?`)) 
            ...
            <Button variant="contained"  onClick={() => {SET_SHOW_CREATE(true); SET_SHOW_UPDATE(null)}} sx={{ m: 1 }}>Создать клиента</Button>
        </Grid>
        </Grid>
        <Grid item xs={6}>
            <Box sx={{ m: 2 }}>
